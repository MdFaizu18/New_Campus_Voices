...
import { Camera, Edit, Lock, Mail, Phone, User, MessageCircle, Star, Eye, EyeOff, Book, Calendar, MapPin } from 'lucide-react';
            ...
            <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <StatCard icon={MessageCircle} label="Feeds Sent" value={user.feedsSent} color="bg-indigo-600" />
                        <StatCard icon={Star} label="Average Rating" value={`${user.averageRating}/5`} color="bg-purple-600" />
                    </div>
                    ...
                    <ProfileSection title="Personal Information">
                        ...
                        <div className="mt-4 flex justify-end">
                            ...
                            >
                                {isEditing ? 'Save' : 'Edit'} <Edit size={16} className="ml-2" />
                            </button>
                        </div>
                    </ProfileSection>
